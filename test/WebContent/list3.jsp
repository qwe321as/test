...
<script type="text/javascript" >
	...
	function star(num, flag) {
		alert(num);
 		alert(flag);
		if (flag) {
 	 session.setAttribute("abc",flag);
		String valeu = (String)session.getAttribute(num);
		alert(valeu);
		alert('별클릭');
		flag=false;
		alert(flag);
			...
			<table>
				<tr>
					<td rowspan="3"><img style="width: 35px;"
						onclick="star()" alt="별" src="./img/별.png"></td>
				...
				<tr>
					...
					<%if(flag){
						%>
					<img style="width: 35px;" alt="별"
						onclick="star(1,<%=flag %>)" src="./img/빈별.png">
						<% 
					}else{
						%>
					<img style="width: 35px;" alt="별"
						onclick="star(1,<%=flag %>)" src="./img/별.png">
				<%} %>
						</td>
